...
9. **Автопродажа** - теперь есть функция автопродажи.
```
...
### Лимиты
Базовый: 0 слотов (нужны права)

С правами: `primeseller.autosell.10` = 10 слотов

Без лимита: `primeseller.autosell.bypass`
